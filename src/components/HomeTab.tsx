...
export default function HomeTab() {
  ...
  return (
    ...
    <div className="h-full w-full bg-[#F2F2F7] dark:bg-[#000000] text-black dark:text-white transition-colors duration-300 overflow-y-auto pb-[180px]" onScroll={handleScroll}>
      {/* Header Tabs */}
