...
import { ChevronDown, Play, Pause, SkipForward, SkipBack, Repeat, Shuffle, ListMusic, Info, MoreHorizontal, Download, SlidersHorizontal } from 'lucide-react';
    ...
    <AnimatePresence>
      ...
      <div className="flex items-center justify-between mb-8 relative z-10">
        ...
        <div className="flex items-center gap-1 -mr-2">
          <button onClick={() => setShowEQ(true)} className="p-2 rounded-full hover:bg-black/5 dark:hover:bg-white/10 transition-colors">
